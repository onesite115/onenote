...
Feature: 
        ...
        3. completedAt - completed Date and Time is not fully asserted at this minute. but I have asserted partially using regular experssion.
...
@ignore
@ongoing_order
Scenario: 	API - PUT /v1/orders/{orderID}/complete
...
When method PUT
Then status 200
* match response contains { id:'#number',status: 'COMPLETED', completedAt: '#regex 2018.*Z' }
...
* def orderCompletedDateTime = response.completedAt
* print "orderCompletedDateTime : ", orderCompletedDateTime
